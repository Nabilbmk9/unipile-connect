...
# ---------- V1: stockage en mémoire (remplacer par DB plus tard)
...
def connect_success(request: Request):
    # Affiche ce qui a été reçu via /unipile/notify (debug V1)
...
def connect_linkedin():
    ...
    Obligatoires: type, providers, api_url (SANS /api/v1), expiresOn.
    """
    ...
    payload = {
        ...
        "name": "anonymous-user",        # remplace par ton vrai user_id si tu as une session
    ...
    # Redirection vers l'assistant hébergé Unipile
